...
interface WorkDetailsSectionProps {
  ...
  validatePositive: (value: string) => boolean;
  validateMinutes: (value: string) => boolean;
  handleOpenGcode: () => void;
}

export const WorkDetailsSection: React.FC<WorkDetailsSectionProps> = ({
  grams,
  setGrams,
  hours,
  setHours,
